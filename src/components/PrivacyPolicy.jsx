...
const PrivacyPolicy = () => {
  return (
    <div className="p-8 max-w-4xl mx-auto bg-white rounded-xl shadow-lg mt-8 font-inter">
      ...
      <h4 className="text-lg font-medium text-gray-700 mb-1">Personal Data</h4>
      <p className="mb-4 text-gray-700">
      ...
      <h4 className="text-lg font-medium text-gray-700 mb-1">Usage Data</h4>
      <p className="mb-4 text-gray-700">
      ...
      <ul className="list-disc list-inside mb-4 text-gray-700">
        ...
        <li><strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read "Where can I change the settings for disabling, or deleting local shared objects?" available at <a href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">Adobe HelpX</a></li>
      ...
      <ul className="list-disc list-inside mb-4 text-gray-700">
        ...
        <li>
          <strong>Cookies Policy / Acceptance Cookies</strong>
        ...
        <li>
          ...
          <p>Type: Persistent Cookies</p>
          <p>Administered by: Us</p>
          <p>Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You visit the Website.</p>
        </li>
      </ul>
      ...
      <h3 className="text-xl font-medium text-gray-700 mb-2">Business Transactions</h3>
      <p className="mb-4 text-gray-700">
      ...
      <h3 className="text-xl font-medium text-gray-700 mb-2">Law enforcement</h3>
      <p className="mb-4 text-gray-700">
        Under certain circumstances, the Company may be required to disclose Your Personal Data if
        required to do so by law or in response to valid requests by public authorities (e.g. a court
        or a government agency).
      </p>
      <h3 className="text-xl font-medium text-gray-700 mb-2">Other legal requirements</h3>
      <p className="mb-4 text-gray-700">
